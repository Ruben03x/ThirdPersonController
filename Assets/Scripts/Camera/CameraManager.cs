...
public class CameraManager : MonoBehaviour
{
    ...
    public Transform cameraTransform; //transform of actual camera object of scene
    public LayerMask collisionLayers; //Layers we want to collide with camera
    private float defaultPosition;
    private Vector3 cameraFollowVelocity = Vector3.zero;
    private Vector3 cameraVectorPosition;

    public float cameraCollisionOffSet = 0.2f; // How much camera will jump off objects colliding woth
